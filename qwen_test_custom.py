...
adapter_path = "./checkpoints/3cbea0ef-881d-4c12-9512-a0962fb29439-qwen-full-inventory/checkpoint-20690"
...
def get_base_model_response():
    ...
    processor = AutoProcessor.from_pretrained(
        base_model_id, use_fast=True, padding_side="left"
    )
...
def get_finetuned_model_response():
    ...
    finetuned_generated_ids = finetuned_output_ids[
        :, inputs_finetuned.input_ids.shape[1] :
    ]
    finetuned_response = processor.batch_decode(
