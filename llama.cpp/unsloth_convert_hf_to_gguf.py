...
try:
    gguf.MODEL_ARCH.MMPROJ
except AttributeError:
    gguf.MODEL_ARCH.MMPROJ = None
try:
    gguf.MODEL_ARCH.GEMMA3N
except AttributeError:
    gguf.MODEL_ARCH.GEMMA3N = None
try:
    gguf.MODEL_ARCH.STABLELM
except AttributeError:
    gguf.MODEL_ARCH.STABLELM = None
try:
    gguf.MODEL_TENSOR.PER_LAYER_TOKEN_EMBD
except AttributeError:
    gguf.MODEL_TENSOR.PER_LAYER_TOKEN_EMBD = None
try:
    gguf.MODEL_ARCH.MINICPM
except AttributeError:
    gguf.MODEL_ARCH.MINICPM = None
try:
    gguf.MODEL_TENSOR.TOKEN_TYPES
except AttributeError:
    gguf.MODEL_TENSOR.TOKEN_TYPES = None
try:
    gguf.MODEL_ARCH.BERT
except AttributeError:
    gguf.MODEL_ARCH.BERT = None
try:
    gguf.MODEL_TENSOR.A_ENC_EMBD_POS
except AttributeError:
    gguf.MODEL_TENSOR.A_ENC_EMBD_POS = None
try:
    gguf.MODEL_ARCH.XVERSE
except AttributeError:
    gguf.MODEL_ARCH.XVERSE = None
try:
    gguf.MODEL_ARCH.MODERN_BERT
except AttributeError:
    gguf.MODEL_ARCH.MODERN_BERT = None
try:
    gguf.MODEL_ARCH.ERNIE4_5
except AttributeError:
    gguf.MODEL_ARCH.ERNIE4_5 = None
try:
    gguf.MODEL_ARCH.GPT2
except AttributeError:
    gguf.MODEL_ARCH.GPT2 = None
try:
    gguf.MODEL_ARCH.QWEN
except AttributeError:
    gguf.MODEL_ARCH.QWEN = None
try:
    gguf.MODEL_TENSOR.V_DS_FC2
except AttributeError:
    gguf.MODEL_TENSOR.V_DS_FC2 = None
try:
    gguf.MODEL_TENSOR.ALTUP_ROUTER
except AttributeError:
    gguf.MODEL_TENSOR.ALTUP_ROUTER = None
try:
    gguf.MODEL_TENSOR.ATTN_V
except AttributeError:
    gguf.MODEL_TENSOR.ATTN_V = None
try:
    gguf.MODEL_ARCH.NOMIC_BERT
except AttributeError:
    gguf.MODEL_ARCH.NOMIC_BERT = None
try:
    gguf.MODEL_ARCH.BAILINGMOE2
except AttributeError:
    gguf.MODEL_ARCH.BAILINGMOE2 = None
try:
    gguf.MODEL_TENSOR.FFN_DOWN
except AttributeError:
    gguf.MODEL_TENSOR.FFN_DOWN = None
try:
    gguf.MODEL_ARCH.HUNYUAN_DENSE
except AttributeError:
    gguf.MODEL_ARCH.HUNYUAN_DENSE = None
try:
    gguf.MODEL_ARCH.QWEN2
except AttributeError:
    gguf.MODEL_ARCH.QWEN2 = None
try:
    gguf.MODEL_TENSOR.ALTUP_PREDICT_COEF
except AttributeError:
    gguf.MODEL_TENSOR.ALTUP_PREDICT_COEF = None
try:
    gguf.MODEL_ARCH.GPTNEOX
except AttributeError:
    gguf.MODEL_ARCH.GPTNEOX = None
try:
    gguf.MODEL_ARCH.DEEPSEEK2
except AttributeError:
    gguf.MODEL_ARCH.DEEPSEEK2 = None
try:
    gguf.MODEL_ARCH.BAICHUAN
except AttributeError:
    gguf.MODEL_ARCH.BAICHUAN = None
try:
    gguf.MODEL_ARCH.MPT
except AttributeError:
    gguf.MODEL_ARCH.MPT = None
try:
    gguf.MODEL_TENSOR.TIME_MIX_W2
except AttributeError:
    gguf.MODEL_TENSOR.TIME_MIX_W2 = None
try:
    gguf.MODEL_ARCH.QWEN3
except AttributeError:
    gguf.MODEL_ARCH.QWEN3 = None
try:
    gguf.MODEL_ARCH.MAMBA
except AttributeError:
    gguf.MODEL_ARCH.MAMBA = None
try:
    gguf.MODEL_ARCH.JINA_BERT_V3
except AttributeError:
    gguf.MODEL_ARCH.JINA_BERT_V3 = None
try:
    gguf.MODEL_TENSOR.TIME_MIX_W1
except AttributeError:
    gguf.MODEL_TENSOR.TIME_MIX_W1 = None
try:
    gguf.MODEL_ARCH.REFACT
except AttributeError:
    gguf.MODEL_ARCH.REFACT = None
try:
    gguf.MODEL_TENSOR.ATTN_K
except AttributeError:
    gguf.MODEL_TENSOR.ATTN_K = None
try:
    gguf.MODEL_ARCH.OLMO
except AttributeError:
    gguf.MODEL_ARCH.OLMO = None
try:
    gguf.MODEL_ARCH.NEMOTRON
except AttributeError:
    gguf.MODEL_ARCH.NEMOTRON = None
try:
    gguf.MODEL_ARCH.T5
except AttributeError:
    gguf.MODEL_ARCH.T5 = None
try:
    gguf.MODEL_ARCH.NEMOTRON_H
except AttributeError:
    gguf.MODEL_ARCH.NEMOTRON_H = None
try:
    gguf.MODEL_ARCH.GROVEMOE
except AttributeError:
    gguf.MODEL_ARCH.GROVEMOE = None
try:
    gguf.MODEL_ARCH.MINIMAXM2
except AttributeError:
    gguf.MODEL_ARCH.MINIMAXM2 = None
try:
    gguf.MODEL_ARCH.CODESHELL
except AttributeError:
    gguf.MODEL_ARCH.CODESHELL = None
try:
    gguf.MODEL_ARCH.OLMOE
except AttributeError:
    gguf.MODEL_ARCH.OLMOE = None
try:
    gguf.MODEL_ARCH.APERTUS
except AttributeError:
    gguf.MODEL_ARCH.APERTUS = None
try:
    gguf.MODEL_ARCH.NEO_BERT
except AttributeError:
    gguf.MODEL_ARCH.NEO_BERT = None
try:
    gguf.MODEL_ARCH.OLMO2
except AttributeError:
    gguf.MODEL_ARCH.OLMO2 = None
try:
    gguf.MODEL_TENSOR.POS_EMBD
except AttributeError:
    gguf.MODEL_TENSOR.POS_EMBD = None
try:
    gguf.MODEL_ARCH.PHIMOE
except AttributeError:
    gguf.MODEL_ARCH.PHIMOE = None
try:
    gguf.MODEL_ARCH.BITNET
except AttributeError:
    gguf.MODEL_ARCH.BITNET = None
try:
    gguf.MODEL_ARCH.GPT_OSS
except AttributeError:
    gguf.MODEL_ARCH.GPT_OSS = None
try:
    gguf.MODEL_ARCH.RWKV6QWEN2
except AttributeError:
    gguf.MODEL_ARCH.RWKV6QWEN2 = None
try:
    gguf.MODEL_ARCH.COMMAND_R
except AttributeError:
    gguf.MODEL_ARCH.COMMAND_R = None
try:
    gguf.MODEL_ARCH.GLM4_MOE
except AttributeError:
    gguf.MODEL_ARCH.GLM4_MOE = None
try:
    gguf.MODEL_ARCH
except AttributeError:
    gguf.MODEL_ARCH = None
try:
    gguf.MODEL_ARCH.LLAMA4
except AttributeError:
    gguf.MODEL_ARCH.LLAMA4 = None
try:
    gguf.MODEL_ARCH.JAIS
except AttributeError:
    gguf.MODEL_ARCH.JAIS = None
try:
    gguf.MODEL_ARCH.GEMMA
except AttributeError:
    gguf.MODEL_ARCH.GEMMA = None
try:
    gguf.MODEL_ARCH.PHI3
except AttributeError:
    gguf.MODEL_ARCH.PHI3 = None
try:
    gguf.MODEL_ARCH.NOMIC_BERT_MOE
except AttributeError:
    gguf.MODEL_ARCH.NOMIC_BERT_MOE = None
try:
    gguf.MODEL_ARCH.RND1
except AttributeError:
    gguf.MODEL_ARCH.RND1 = None
try:
    gguf.MODEL_ARCH.JINA_BERT_V2
except AttributeError:
    gguf.MODEL_ARCH.JINA_BERT_V2 = None
try:
    gguf.MODEL_TENSOR.FFN_GATE
except AttributeError:
    gguf.MODEL_TENSOR.FFN_GATE = None
try:
    gguf.MODEL_ARCH.GROK
except AttributeError:
    gguf.MODEL_ARCH.GROK = None
try:
    gguf.MODEL_TENSOR.SSM_NORM
except AttributeError:
    gguf.MODEL_TENSOR.SSM_NORM = None
try:
    gguf.MODEL_ARCH.COGVLM
except AttributeError:
    gguf.MODEL_ARCH.COGVLM = None
try:
    gguf.MODEL_TENSOR.TIME_MIX_LERP_FUSED
except AttributeError:
    gguf.MODEL_TENSOR.TIME_MIX_LERP_FUSED = None
try:
    gguf.MODEL_ARCH.GRANITE
except AttributeError:
    gguf.MODEL_ARCH.GRANITE = None
try:
    gguf.MODEL_ARCH.COHERE2
except AttributeError:
    gguf.MODEL_ARCH.COHERE2 = None
try:
    gguf.MODEL_TENSOR
except AttributeError:
    gguf.MODEL_TENSOR = None
try:
    gguf.MODEL_TENSOR.FFN_GATE_INP
except AttributeError:
    gguf.MODEL_TENSOR.FFN_GATE_INP = None
try:
    gguf.MODEL_ARCH.ARWKV7
except AttributeError:
    gguf.MODEL_ARCH.ARWKV7 = None
try:
    gguf.MODEL_TENSOR.FFN_UP
except AttributeError:
    gguf.MODEL_TENSOR.FFN_UP = None
try:
    gguf.MODEL_ARCH.QWEN3MOE
except AttributeError:
    gguf.MODEL_ARCH.QWEN3MOE = None
try:
    gguf.MODEL_ARCH.LFM2
except AttributeError:
    gguf.MODEL_ARCH.LFM2 = None
try:
    gguf.MODEL_ARCH.FALCON
except AttributeError:
    gguf.MODEL_ARCH.FALCON = None
try:
    gguf.MODEL_ARCH.OPENELM
except AttributeError:
    gguf.MODEL_ARCH.OPENELM = None
try:
    gguf.MODEL_TENSOR.SHORTCONV_CONV
except AttributeError:
    gguf.MODEL_TENSOR.SHORTCONV_CONV = None
try:
    gguf.MODEL_ARCH.STARCODER2
except AttributeError:
    gguf.MODEL_ARCH.STARCODER2 = None
try:
    gguf.MODEL_TENSOR.SSM_CONV1D
except AttributeError:
    gguf.MODEL_TENSOR.SSM_CONV1D = None
try:
    gguf.MODEL_TENSOR.TIME_MIX_FIRST
except AttributeError:
    gguf.MODEL_TENSOR.TIME_MIX_FIRST = None
try:
    gguf.MODEL_TENSOR.LAUREL_R
except AttributeError:
    gguf.MODEL_TENSOR.LAUREL_R = None
try:
    gguf.MODEL_ARCH.NEMOTRON_H_MOE
except AttributeError:
    gguf.MODEL_ARCH.NEMOTRON_H_MOE = None
try:
    gguf.MODEL_TENSOR.LAUREL_L
except AttributeError:
    gguf.MODEL_TENSOR.LAUREL_L = None
try:
    gguf.MODEL_TENSOR.V_DS_NORM
except AttributeError:
    gguf.MODEL_TENSOR.V_DS_NORM = None
try:
    gguf.MODEL_TENSOR.V_DS_FC1
except AttributeError:
    gguf.MODEL_TENSOR.V_DS_FC1 = None
try:
    gguf.MODEL_ARCH.GLM4
except AttributeError:
    gguf.MODEL_ARCH.GLM4 = None
try:
    gguf.MODEL_ARCH.EXAONE
except AttributeError:
    gguf.MODEL_ARCH.EXAONE = None
try:
    gguf.MODEL_ARCH.T5ENCODER
except AttributeError:
    gguf.MODEL_ARCH.T5ENCODER = None
try:
    gguf.MODEL_ARCH.LLADA_MOE
except AttributeError:
    gguf.MODEL_ARCH.LLADA_MOE = None
try:
    gguf.MODEL_TENSOR.POSNET_NORM2
except AttributeError:
    gguf.MODEL_TENSOR.POSNET_NORM2 = None
try:
    gguf.MODEL_ARCH.BLOOM
except AttributeError:
    gguf.MODEL_ARCH.BLOOM = None
try:
    gguf.MODEL_ARCH.PHI2
except AttributeError:
    gguf.MODEL_ARCH.PHI2 = None
try:
    gguf.MODEL_ARCH.LLAMA_EMBED
except AttributeError:
    gguf.MODEL_ARCH.LLAMA_EMBED = None
try:
    gguf.MODEL_ARCH.AFMOE
except AttributeError:
    gguf.MODEL_ARCH.AFMOE = None
try:
    gguf.MODEL_ARCH.CHAMELEON
except AttributeError:
    gguf.MODEL_ARCH.CHAMELEON = None
try:
    gguf.MODEL_ARCH.QWEN3VL
except AttributeError:
    gguf.MODEL_ARCH.QWEN3VL = None
try:
    gguf.MODEL_ARCH.EXAONE4
except AttributeError:
    gguf.MODEL_ARCH.EXAONE4 = None
try:
    gguf.MODEL_ARCH.LLADA
except AttributeError:
    gguf.MODEL_ARCH.LLADA = None
try:
    gguf.MODEL_ARCH.GRANITE_MOE
except AttributeError:
    gguf.MODEL_ARCH.GRANITE_MOE = None
try:
    gguf.MODEL_ARCH.DREAM
except AttributeError:
    gguf.MODEL_ARCH.DREAM = None
try:
    gguf.MODEL_ARCH.DEEPSEEK
except AttributeError:
    gguf.MODEL_ARCH.DEEPSEEK = None
try:
    gguf.MODEL_ARCH.PLAMO
except AttributeError:
    gguf.MODEL_ARCH.PLAMO = None
try:
    gguf.MODEL_ARCH.WAVTOKENIZER_DEC
except AttributeError:
    gguf.MODEL_ARCH.WAVTOKENIZER_DEC = None
try:
    gguf.MODEL_TENSOR.TIME_MIX_DECAY_W1
except AttributeError:
    gguf.MODEL_TENSOR.TIME_MIX_DECAY_W1 = None
try:
    gguf.MODEL_ARCH.LFM2MOE
except AttributeError:
    gguf.MODEL_ARCH.LFM2MOE = None
try:
    gguf.MODEL_ARCH.QWEN3NEXT
except AttributeError:
    gguf.MODEL_ARCH.QWEN3NEXT = None
try:
    gguf.MODEL_ARCH.MIMO2
except AttributeError:
    gguf.MODEL_ARCH.MIMO2 = None
try:
    gguf.MODEL_ARCH.CHATGLM
except AttributeError:
    gguf.MODEL_ARCH.CHATGLM = None
try:
    gguf.MODEL_ARCH.QWEN3VLMOE
except AttributeError:
    gguf.MODEL_ARCH.QWEN3VLMOE = None
try:
    gguf.MODEL_ARCH.INTERNLM2
except AttributeError:
    gguf.MODEL_ARCH.INTERNLM2 = None
try:
    gguf.MODEL_ARCH.ORION
except AttributeError:
    gguf.MODEL_ARCH.ORION = None
try:
    gguf.MODEL_ARCH.SMOLLM3
except AttributeError:
    gguf.MODEL_ARCH.SMOLLM3 = None
try:
    gguf.MODEL_ARCH.QWEN2MOE
except AttributeError:
    gguf.MODEL_ARCH.QWEN2MOE = None
try:
    gguf.MODEL_TENSOR.V_ENC_EMBD_POS
except AttributeError:
    gguf.MODEL_TENSOR.V_ENC_EMBD_POS = None
try:
    gguf.MODEL_ARCH.SEED_OSS
except AttributeError:
    gguf.MODEL_ARCH.SEED_OSS = None
try:
    gguf.MODEL_ARCH.GEMMA3
except AttributeError:
    gguf.MODEL_ARCH.GEMMA3 = None
try:
    gguf.MODEL_ARCH.GRANITE_HYBRID
except AttributeError:
    gguf.MODEL_ARCH.GRANITE_HYBRID = None
try:
    gguf.MODEL_ARCH.DBRX
except AttributeError:
    gguf.MODEL_ARCH.DBRX = None
try:
    gguf.MODEL_TENSOR.OUTPUT
except AttributeError:
    gguf.MODEL_TENSOR.OUTPUT = None
try:
    gguf.MODEL_TENSOR.TIME_MIX_DECAY_W2
except AttributeError:
    gguf.MODEL_TENSOR.TIME_MIX_DECAY_W2 = None
try:
    gguf.MODEL_ARCH.MAMBA2
except AttributeError:
    gguf.MODEL_ARCH.MAMBA2 = None
try:
    gguf.MODEL_ARCH.FALCON_H1
except AttributeError:
    gguf.MODEL_ARCH.FALCON_H1 = None
try:
    gguf.MODEL_ARCH.GEMMA_EMBEDDING
except AttributeError:
    gguf.MODEL_ARCH.GEMMA_EMBEDDING = None
try:
    gguf.MODEL_ARCH.MINICPM3
except AttributeError:
    gguf.MODEL_ARCH.MINICPM3 = None
try:
    gguf.MODEL_ARCH.RWKV7
except AttributeError:
    gguf.MODEL_ARCH.RWKV7 = None
try:
    gguf.MODEL_ARCH.RWKV6
except AttributeError:
    gguf.MODEL_ARCH.RWKV6 = None
try:
    gguf.MODEL_ARCH.ARCEE
except AttributeError:
    gguf.MODEL_ARCH.ARCEE = None
try:
    gguf.MODEL_TENSOR.TOKEN_EMBD
except AttributeError:
    gguf.MODEL_TENSOR.TOKEN_EMBD = None
try:
    gguf.MODEL_ARCH.GEMMA2
except AttributeError:
    gguf.MODEL_ARCH.GEMMA2 = None
try:
    gguf.MODEL_ARCH.BAILINGMOE
except AttributeError:
    gguf.MODEL_ARCH.BAILINGMOE = None
try:
    gguf.MODEL_ARCH.HUNYUAN_MOE
except AttributeError:
    gguf.MODEL_ARCH.HUNYUAN_MOE = None
try:
    gguf.MODEL_ARCH.PANGU_EMBED
except AttributeError:
    gguf.MODEL_ARCH.PANGU_EMBED = None
try:
    gguf.MODEL_TENSOR.SSM_D
except AttributeError:
    gguf.MODEL_TENSOR.SSM_D = None
try:
    gguf.MODEL_TENSOR.ATTN_OUT
except AttributeError:
    gguf.MODEL_TENSOR.ATTN_OUT = None
try:
    gguf.MODEL_ARCH.MISTRAL3
except AttributeError:
    gguf.MODEL_ARCH.MISTRAL3 = None
try:
    gguf.MODEL_ARCH.DOTS1
except AttributeError:
    gguf.MODEL_ARCH.DOTS1 = None
try:
    gguf.MODEL_ARCH.QWEN2VL
except AttributeError:
    gguf.MODEL_ARCH.QWEN2VL = None
try:
    gguf.MODEL_TENSOR.ALTUP_CORRECT_COEF
except AttributeError:
    gguf.MODEL_TENSOR.ALTUP_CORRECT_COEF = None
try:
    gguf.MODEL_ARCH.LLAMA
except AttributeError:
    gguf.MODEL_ARCH.LLAMA = None
try:
    gguf.MODEL_ARCH.DECI
except AttributeError:
    gguf.MODEL_ARCH.DECI = None
try:
    gguf.MODEL_TENSOR.SSM_A
except AttributeError:
    gguf.MODEL_TENSOR.SSM_A = None
try:
    gguf.MODEL_ARCH.STARCODER
except AttributeError:
    gguf.MODEL_ARCH.STARCODER = None
try:
    gguf.MODEL_ARCH.PLM
except AttributeError:
    gguf.MODEL_ARCH.PLM = None
try:
    gguf.MODEL_ARCH.JAMBA
except AttributeError:
    gguf.MODEL_ARCH.JAMBA = None
try:
    gguf.MODEL_TENSOR.ATTN_Q
except AttributeError:
    gguf.MODEL_TENSOR.ATTN_Q = None
try:
    gguf.MODEL_ARCH.ARCTIC
except AttributeError:
    gguf.MODEL_ARCH.ARCTIC = None
try:
    gguf.MODEL_ARCH.PLAMO2
except AttributeError:
    gguf.MODEL_ARCH.PLAMO2 = None
try:
    gguf.MODEL_ARCH.ERNIE4_5_MOE
except AttributeError:
    gguf.MODEL_ARCH.ERNIE4_5_MOE = None
try:
    gguf.MODEL_ARCH.SMALLTHINKER
except AttributeError:
    gguf.MODEL_ARCH.SMALLTHINKER = None
try:
    gguf.MODEL_TENSOR.POSNET_NORM1
except AttributeError:
    gguf.MODEL_TENSOR.POSNET_NORM1 = None
...
class ModelBase:
    ...
    def index_tensors(
        ...
        if remote_hf_model_id is not None:
            ...
            for name, remote_tensor in remote_tensors.items():
                tensors[name] = (
                    lambda r=remote_tensor: LazyTorchTensor.from_remote_tensor(r)
                )
            ...
            with ctx as model_part:
                ...
                for name in model_part.keys():
                    if is_safetensors:
                        ...
                        if self.lazy:
                            data_gen = (
                                lambda data=data: LazyTorchTensor.from_local_tensor(
                                    data
                                )
                            )  # noqa: E731
                        else:
                            ...
                            data_gen = (
                                lambda data=data, dtype=dtype: torch.from_numpy(
                                    data.mmap_bytes()
                                )
                                .view(dtype)
                                .reshape(data.shape)
                        ...
                        if self.lazy:
                            data_gen = (
                                lambda data=data_torch: LazyTorchTensor.from_eager(data)
                            )  # noqa: E731
                        else:
                ...
                for name in self.model_tensors.keys():
                    if name.endswith(".weight_scale"):
                        ...
                        self.model_tensors[weight_name] = (
                            lambda w=w, s=s: dequant_bitnet(w(), s())
                        )
                ...
                if (
                    ...
                    for name in self.model_tensors.keys():
                        if name.endswith(".weight_scale"):
                            ...
                            s = self.model_tensors[name]
                            self.model_tensors[weight_name] = (
                                lambda w=w, s=s: dequant_simple(w(), s(), block_size)
                            )
                            tensors_to_remove.append(name)
    ...
    def prepare_metadata(self, vocab_only: bool):
        ...
        if hasattr(self.metadata, "quantized_by"):
            self.metadata.quantized_by = "Unsloth"
        if hasattr(self.metadata, "repo_url"):
            self.metadata.repo_url = "https://huggingface.co/unsloth"
        if hasattr(self.metadata, "tags"):
            self.metadata.tags = ["unsloth", "llama.cpp"]
...
class TextModel(ModelBase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if (
            ...
            if (
                "rope_theta" not in self.rope_parameters
                and (
                    rope_theta := self.find_hparam(
                        ["rope_theta", "global_rope_theta", "rotary_emb_base"],
                        optional=True,
                    )
                )
                is not None
    ...
    def set_gguf_parameters(self):
        ...
        if self.has_vision_encoder:
            ...
            self.gguf_writer.add_vision_head_count(
                self.find_vparam(["num_attention_heads", "num_heads"])
            )
    ...
    def set_vocab(self):
        ...
        if tokenizer_file.is_file():
            with open(tokenizer_file, "r", encoding="utf-8") as f:
                ...
                for token_data in added_tokens:
                    token_id = int(token_data["id"])
                    token = token_data["content"].encode("utf-8")
                    if toktypes[token_id] != SentencePieceTokenTypes.UNUSED:
        ...
        # Check if original tokenizer.json exists for additional processing
        tokenizer_file = self.dir_model / "tokenizer.json"
        if tokenizer_file.is_file():
            with open(tokenizer_file, "r", encoding="utf-8") as f:
                tokenizer_json = json.load(f)
...
class InternLM3Model(TextModel):
    ...
    def set_vocab(self):
        ...
        # Read added tokens from tokenizer.json
        tokenizer_file = self.dir_model / "tokenizer.json"
        if tokenizer_file.is_file():
            with open(tokenizer_file, "r", encoding="utf-8") as f:
                tokenizer_json = json.load(f)
...
class ArcticModel(TextModel):
    ...
    def set_vocab(self):
        ...
        # Use the added_tokens field from tokenizer.json as the source
        # of information about added/redefined tokens and modify them accordingly.
        # Also read unk_token from tokenizer_config.json if available
        unk_token = None
        tokenizer_config_file = self.dir_model / "tokenizer_config.json"
        if tokenizer_config_file.is_file():
            with open(tokenizer_config_file, "r", encoding="utf-8") as f:
        ...
        if tokenizer_file.is_file():
            with open(tokenizer_file, "r", encoding="utf-8") as f:
                ...
                for token_data in added_tokens:
                    ...
                    if token_data.get("special"):
                        if unk_token and token_content == unk_token:
...
class GlmASRWhisperEncoderModel(MmprojModel):
    ...
    def modify_tensors(
        ...
        if name.startswith("audio_encoder.audio_bos_eos_token."):
            return [
                (self.map_tensor_name("model.vision.boi"), data_torch[0]),
                (self.map_tensor_name("model.vision.eoi"), data_torch[1]),
            ]
...
class ModernBertModel(BertModel):
    ...
    def set_gguf_parameters(self):
        ...
        if (
            ...
            self.gguf_writer.add_sliding_window_pattern(sliding_window_pattern)
        self.gguf_writer.add_rope_freq_base_swa(
            self.rope_parameters.get(
                "sliding_attention",
                {"rope_theta": self.hparams.get("local_rope_theta")},
            )["rope_theta"]
        )
        self.gguf_writer.add_rope_scaling_type(gguf.RopeScalingType.NONE)
        self.gguf_writer.add_vocab_size(self.hparams["vocab_size"])
...
class LazyTorchTensor(gguf.LazyBase):
    ...
    def from_remote_tensor(cls, remote_tensor: gguf.utility.RemoteTensor):
        ...
        lazy = cls(
            meta=meta,
            args=(remote_tensor,),
            func=lambda r: torch.from_numpy(
                byteswap_tensor(np.frombuffer(r.data(), dtype=numpy_dtype), numpy_dtype)
            )
            .view(dtype)
            .reshape(shape),
        )
